...
exports.loadInit = exports.loadServer = exports.loadController = exports.ArcHttpApplication = void 0;
var express_1 = __importDefault(require("express"));
var routers_1 = require("../controller/routers");
var index_1 = require("./index");
var process_1 = require("process");
var path_1 = __importDefault(require("path"));
var ArcOrm_1 = require("../orm/ArcOrm");
...
var ArcHttpApplication = function (port) {
    return function (value, context) {
        context.addInitializer(function () {
            ...
            // 加载数据库
            index_1.ApplicationEvents.on(index_1.Application.LOAD_DATABASE, ArcOrm_1.ArcOrm.CreatePool);
            // 全局管道
...
exports.ArcHttpApplication = ArcHttpApplication;
